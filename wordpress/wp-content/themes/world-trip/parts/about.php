<!-- Partie About présente sur la page d'accueil -->
</div>
<div id="about" class="mt-5"><img class="img-fluid mt-5" src="<?php echo get_template_directory_uri(); ?>/img/photo-about.png" alt="Image about"></div>
